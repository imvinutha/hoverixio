...
import { CheckCircle2, ArrowUpRight, Users, BookOpen, Briefcase, Globe2 } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 text-purple-400 text-sm font-medium mb-6">
              ...
              <span>Hoverixio Academy</span>
              <span className="text-purple-500/60">·</span>
              <span className="text-purple-300">Prices in {country.currency}</span>
            </span>
            ...
            <p className="text-xl text-slate-400 leading-relaxed mb-8">
              Master modern web development with our comprehensive courses. <span className="text-white font-semibold">Prices automatically tailored for {country.name}!</span>
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {academyCourses.map((course, i) => {
              const rawPrice = getServiceRawPrice(course.title);
              const displayPrice = rawPrice === null ? course.price : formatPrice(rawPrice);
              ...
              return (
                <motion.div
                  ...
                  className="group"
                >
                  <div className="relative overflow-hidden rounded-3xl border border-white/10 hover:border-purple-500/30 transition-all bg-slate-900 h-full flex flex-col">
                    ...
                    <div className="p-8 flex flex-col flex-1">
                      ...
                      <div className="flex items-center justify-between border-t border-white/10 pt-6">
                        <div>
                          ...
                          <div className="text-xs text-slate-500 mt-1">+ {country.vatRate * 100}% VAT if applicable</div>
                        </div>
