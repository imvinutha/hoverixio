...
import { CheckCircle2, ArrowUpRight, Gift, Sparkles, Zap } from 'lucide-react';
            ...
            {pricingPlans.map((plan, i) => (
              ...
              >
                ...
                <div className="pt-2">
                  ...
                  <div className="mb-8">
                    <div className="text-4xl md:text-5xl font-bold text-white mb-1">{plan.price}</div>
                  ...
                  <ul className="space-y-3 mb-8">
                    {plan.features.map((feature, j) => (
                      <li key={j} className={cn(
                        ...
                        feature.includes("🎁") && "p-3 rounded-xl bg-gradient-to-r from-orange-500/10 to-pink-500/10 -mx-2 border border-orange-500/20"
                      )}>
                        <CheckCircle2 className={cn(
                          "w-5 h-5 flex-shrink-0 mt-0.5",
                          feature.includes("🎁") ? "text-orange-400" : "text-green-400"
                        )} />
                        <span className={cn(
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "Which domain extension do you provide for free?", a: "We provide a FREE .com domain (worth ₹1,299/year) with all our website packages. If you prefer .in, .co.in, or other extensions, we can arrange those too at no extra cost!" },
              { q: "What are the hosting specifications?", a: "Our FREE hosting includes: 10GB SSD Storage, Unlimited Bandwidth, Free SSL Certificate, 99.9% Uptime Guarantee, cPanel Access, Weekly Backups, and 24/7 Technical Support. Perfect for any business website!" },
              { q: "What payment methods do you accept?", a: "We accept all major credit cards, debit cards, UPI (Google Pay, PhonePe, Paytm), bank transfers, and even cash payments for local clients. Flexible EMI options available for larger projects!" },
              ...
              { q: "Do you offer ongoing support?", a: "Yes! Every project includes free support for 30 days after launch. We also offer affordable monthly maintenance and support packages starting at just ₹999/month to keep your website running smoothly." },
            ].map((faq, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
