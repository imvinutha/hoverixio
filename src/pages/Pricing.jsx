        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <div className="relative bg-slate-950/90 backdrop-blur rounded-[22px] px-6 py-8 sm:px-10 sm:py-10 text-center">
              ...
              <p className="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto mb-6">
                On all website packages. Pay only for development - launch
                your business online with zero extra costs!
              </p>
      ...
      <section className="py-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            {/* Automatic Country / Currency Display */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {pricingPlans.map((plan, i) => {
              ...
              /*
               * Important:
               * Never fall back to plan.price here.
               * plan.price contains the old Indian prices.
               *
               * Country-specific prices come exclusively
               * from PRICE_MATRIX in pricingContext.js.
               */
              ...
              return (
                ...
                >
                  ...
                  <div className="pt-2 flex flex-col flex-1">
                    ...
                    {/* Description */}
                    <p className="text-slate-400 mb-6 text-sm min-h-[48px]">
                      {plan.description}
                    </p>
                        ...
                        return (
                          <li
                            ...
                            className={cn(
                              ...
                              isFree &&
                                'p-3 rounded-xl bg-gradient-to-r from-orange-500/10 to-pink-500/10 -mx-2 border border-orange-500/20'
                            )}
                          >
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-4">
            ...
            {[
              {
                q: 'Is Domain & Hosting really FREE? What\'s the catch?',
                a: 'Yes, it\'s 100% FREE! We include a .com domain and high-speed hosting for 1 year with all our website packages. No hidden fees, no strings attached. After 1 year, you can renew at standard rates or transfer to your own provider - it\'s completely up to you!',
              },

              {
                q: 'How is my pricing currency determined?',
                a: `Pricing is automatically displayed based on your current location. Visitors from ${country.name} see prices in ${country.currency} (${country.currencySymbol}).`,
              },

              {
                q: 'Which domain extension do you provide for free?',
                a: 'We provide a FREE .com domain with all our website packages. If you prefer .in, .de, .ae, .my, .sg, .co or other extensions, we can arrange those too at no extra cost (or small difference for premium TLDs).',
              },

              {
                q: 'What payment methods do you accept?',
                a: 'We accept all major credit cards, debit cards, local payment methods (UPI in India, Giropay/Sofort in Germany, ACH in US, Apple/Google Pay, GrabPay in MY/SG, etc.), bank transfers, and crypto for larger projects. Flexible EMI/payment plans available!',
              },

              {
                q: 'How long does a typical project take?',
                a: 'Project timelines vary depending on complexity: Starter Website (1-2 weeks), Business Website (2-3 weeks), Premium Website (3-4 weeks), E-commerce Store (3-5 weeks). Rush delivery available at no extra cost!',
              },
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="relative p-12 md:p-16">
              ...
              <p className="text-xl text-slate-200 mb-10 max-w-2xl mx-auto">
                Every business is unique. Let's discuss your project and
                create a custom plan with {country.currencySymbol} pricing
