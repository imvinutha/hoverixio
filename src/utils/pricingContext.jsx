...
//     'Business Website': 3299,
//     'Premium Website': 5999,
//     'E-commerce Store': 9999,
//     'Mobile App': 19999,
//     'MERN Stack Training': 3999,
//     'Full Stack Development Course': 3999,
...
export function PricingProvider({ children }) {
  ...
  const value = {
    ...
    getServiceRawPrice: (name) =>
      getServicePrice(name, countryCode),
  };
...
export function usePricing() {
  ...
  if (!ctx) {
    throw new Error(
      'usePricing must be used within PricingProvider'
    );
  }
